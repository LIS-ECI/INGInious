...
from inginious.frontend.webapp_contest.pages.api._api_page import APIAuthenticatedPage, APINotFound, APIForbidden, APIInvalidArguments, APIError
...
def _get_submissions(course_factory, submission_manager, user_manager, courseid, taskid, with_input, submissionid=None):
    """
        ...
        :type submission_manager: inginious.frontend.webapp_contest.submission_manager.WebAppSubmissionManager
    """
