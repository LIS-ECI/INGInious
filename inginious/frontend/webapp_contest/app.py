...
from inginious.frontend.webapp_contest.database_updater import update_database
...
from inginious.frontend.webapp_contest.courses import WebAppCourse
...
urls = (
    ...
    r'/contest/([^/]+)/([^/]+)/clarifications', 'inginious.frontend.webapp_contest.pages.clarification.ClarificationListPage',
    r'/contest/([^/]+)/([^/]+)/([^/]+)/clarification', 'inginious.frontend.webapp_contest.pages.clarification.ClarificationDetailPage',
    r'/contest/([^/]+)/([^/]+)/clarifications/request', 'inginious.frontend.webapp_contest.pages.clarification.ClarificationRequestPage',
    ...
    r'/admin/([^/]+)/student/([^/]+)/([^/]+)', 'inginious.frontend.webapp_contest.pages.course_admin.student_task.CourseStudentTaskPage',
    r'/admin/([^/]+)/student/([^/]+)/([^/]+)/([^/]+)', 'inginious.frontend.webapp_contest.pages.course_admin.submission.CourseStudentTaskSubmission',
    r'/admin/([^/]+)/aggregations', 'inginious.frontend.webapp_contest.pages.course_admin.aggregation_list.CourseAggregationListPage',
    r'/admin/([^/]+)/aggregation/([^/]+)', 'inginious.frontend.webapp_contest.pages.course_admin.aggregation_info.CourseAggregationInfoPage',
    r'/admin/([^/]+)/aggregation/([^/]+)/([^/]+)', 'inginious.frontend.webapp_contest.pages.course_admin.aggregation_task.CourseAggregationTaskPage',
    r'/admin/([^/]+)/tasks', 'inginious.frontend.webapp_contest.pages.course_admin.task_list.CourseTaskListPage',
    r'/admin/([^/]+)/task/([^/]+)', 'inginious.frontend.webapp_contest.pages.course_admin.task_info.CourseTaskInfoPage',
    r'/admin/([^/]+)/edit/aggregation/([^/]+)', 'inginious.frontend.webapp_contest.pages.course_admin.aggregation_edit.CourseEditAggregation',
    r'/admin/([^/]+)/edit/aggregations', 'inginious.frontend.webapp_contest.pages.course_admin.aggregation_edit.CourseEditAggregation',
    r'/admin/([^/]+)/edit/task/([^/]+)', 'inginious.frontend.webapp_contest.pages.course_admin.task_edit.CourseEditTask',
    r'/admin/([^/]+)/edit/task/([^/]+)/files', 'inginious.frontend.webapp_contest.pages.course_admin.task_edit_file.CourseTaskFiles',
    r'/admin/([^/]+)/download', 'inginious.frontend.webapp_contest.pages.course_admin.download.CourseDownloadSubmissions',
    r'/admin/([^/]+)/replay', 'inginious.frontend.webapp_contest.pages.course_admin.replay.CourseReplaySubmissions',
    r'/admin/([^/]+)/danger', 'inginious.frontend.webapp_contest.pages.course_admin.danger_zone.CourseDangerZonePage',
    r'/api/v0/auth_methods', 'inginious.frontend.webapp_contest.pages.api.auth_methods.APIAuthMethods',
    r'/api/v0/authentication', 'inginious.frontend.webapp_contest.pages.api.authentication.APIAuthentication',
    r'/api/v0/courses', 'inginious.frontend.webapp_contest.pages.api.courses.APICourses',
    r'/api/v0/courses/([a-zA-Z_\-\.0-9]+)', 'inginious.frontend.webapp_contest.pages.api.courses.APICourses',
    r'/api/v0/courses/([a-zA-Z_\-\.0-9]+)/tasks', 'inginious.frontend.webapp_contest.pages.api.tasks.APITasks',
    r'/api/v0/courses/([a-zA-Z_\-\.0-9]+)/tasks/([a-zA-Z_\-\.0-9]+)', 'inginious.frontend.webapp_contest.pages.api.tasks.APITasks',
    r'/api/v0/courses/([a-zA-Z_\-\.0-9]+)/tasks/([a-zA-Z_\-\.0-9]+)/submissions', 'inginious.frontend.webapp_contest.pages.api.submissions.APISubmissions',
    r'/api/v0/courses/([a-zA-Z_\-\.0-9]+)/tasks/([a-zA-Z_\-\.0-9]+)/submissions/([a-zA-Z_\-\.0-9]+)',
        'inginious.frontend.webapp_contest.pages.api.submissions.APISubmissionSingle',
)

urls_maintenance = (
    '/.*', 'inginious.frontend.webapp_contest.pages.maintenance.MaintenancePage'
)
...
def get_app(config):
    ...
    if config.get("maintenance", False):
        template_helper = TemplateHelper(PluginManager(), 'frontend/webapp_contest/templates',
                                         'frontend/webapp_contest/templates/layout',
    ...
    appli.run_file = config.get("run_file",None)
