...
class RegistrationPage(INGIniousPage):
    ...
    def GET(self):
        ...
        return self.template_helper.get_custom_renderer('frontend/webapp_contest/plugins/auth/db_auth').register(reset, msg, error)
...
class ProfilePage(INGIniousAuthPage):
    ...
    def GET_AUTH(self):  # pylint: disable=arguments-differ
        ...
        return self.template_helper.get_custom_renderer('frontend/webapp_contest/plugins/auth/db_auth').profile("", False, allow_deletion)
    ...
    def POST_AUTH(self):  # pylint: disable=arguments-differ
        ...
        return self.template_helper.get_custom_renderer('frontend/webapp_contest/plugins/auth/db_auth').profile(msg, error, allow_deletion)
...
def main_menu(template_helper, database):
    ...
    return str(template_helper.get_custom_renderer('frontend/webapp_contest/plugins/auth/db_auth', layout=False).main_menu(is_user_in_db))
