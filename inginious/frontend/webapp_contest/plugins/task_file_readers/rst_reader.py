...
from inginious.frontend.webapp_contest.plugins.task_file_readers._dicttorst import dict2rst
from inginious.frontend.webapp_contest.plugins.task_file_readers._rsttodict import rst2dict
...
def init(plugin_manager, _, _2, _3):
    """
        ...
        ::
            ...
            plugins:
                - plugin_module: inginious.frontend.webapp_contest.plugins.task_file_readers.rst_reader
    """
